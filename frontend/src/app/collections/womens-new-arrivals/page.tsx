...
export default function WomensNewArrivalsPage() {
    ...
    const filteredProducts = filterProducts(womensNewArrivals, {
        filters,
    });
    return (
        <main className="bg-[#ece9e2] px-3 pt-[40px] pb-0">
            <section className="mx-auto max-w-[1880px]">
                ...
                <CollectionToolbar
                    ...
                    sizes={["XS", "S", "M", "L", "XL", "5", "5.5", "6", "6.5", "7", "7.5", "8", "8.5", "9", "9.5", "10", "10.5", "11"]}
                    colors={["Black", "Grey", "White", "Beige", "Brown", "Red", "Yellow", "Green", "Blue"]}
                    prices={["Under $75", "$76 - $100", "$101 - $125", "$126 - $150"]}
                    productTypes={["Everyday Sneakers", "Flats", "High Tops", "Running Shoes", "Slip Ons", "Slippers", "Socks", "Sweatpants", "Sweatshirts", "Water-Repellent Shoes"]}
                    materials={["Canvas", "Cotton", "Sugar", "Tree", "Wool"]}
                    gender="women"
                ...
                <FAQSection
                    ...
                    description="Discover the latest women’s new arrivals at Allbirds—fresh, innovative styles designed with comfort, sustainability, and effortless style in mind. Explore new shoes, flats, apparel, and accessories crafted from eco-friendly materials like merino wool, tree fiber, and sugarcane. Each piece combines lightweight comfort with versatile design, making it easy to look and feel great every day. Check back often for new colors, limited-edition drops, and updated takes on fan favorites, all thoughtfully created with the planet in mind."
                    faqs={womensFaqs}
                />
                <ValuePillars />
            </section>
