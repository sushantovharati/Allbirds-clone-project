...
const styleCards = [
    {
        image:
            "https://www.allbirds.com/cdn/shop/files/26Q1_DasherNZ_PDP_Mens_HowToStyle_DesktopMobile_2x3_01.jpg?v=1769467173&width=1024",
        title: "LOOK GOOD",
        description:
    ...
    {
        image:
            "https://www.allbirds.com/cdn/shop/files/26Q1_DasherNZ_PDP_Mens_HowToStyle_DesktopMobile_2x3_02.jpg?v=1769467171&width=1024",
        title: "FEEL GOOD",
        description:
...
export default function MenDasherNz({
    gender = "men",
}: ProductProps) {
